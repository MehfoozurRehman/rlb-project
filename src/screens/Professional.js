      ...
      <>
        ...
        <div className="jumbotron__professional">
          ...
          <div className="jumbotron__professional-content">
            <div className="jumbotron__professional-content-left">
              <div className="jumbotron__professional-content-left-heading">
                Junior System Engineer Werktuigbouwkunde
              </div>
              <div className="jumbotron__professional-content-left-row">
                <div className="jumbotron__professional-content-left-row-entity">
                  <svg
                    id="Group_976"
                    data-name="Group 976"
              ...
              <div className="jumbotron__professional-content-left-info">
                Geplaatst op 27 november 2020 - Sluit op 27 december 2020
              </div>
            </div>
            <div className="jumbotron__professional-content-right">
              <div className="jumbotron__professional-content-right-container">
                <div className="jumbotron__professional-content-right-container-header">
                  <button className="jumbotron__professional-content-right-container-header-left">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="25.249"
                      height="25"
                  ...
                  <div className="jumbotron__professional-content-right-container-header-right">
                    <div className="jumbotron__professional-content-right-container-header-right-heading">
                      Lorem, ipsum.
                    </div>
                    <div className="jumbotron__professional-content-right-container-header-right-info">
                      Deel jouw cv
                    </div>
                  </div>
                </div>
                <div className="jumbotron__professional-content-right-container-row">
                  <div className="jumbotron__professional-content-right-container-row-info">
                    Als je op verstuur klikt, ga je akkoord met de voorwaarden
                  </div>
                  <button className="jumbotron__professional-content-right-container-row-btn">
                    Verstuur
                  </button>
                </div>
              </div>
        ...
        <div className="professional__about-section">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="professional__about-section-content">
            <div className="professional__about-section-content-left">
              <div className="professional__about-section-content-left-card">
                <div className="professional__about-section-content-left-card-heading">
                  <div className="professional__about-section-content-left-card-heading-icon"></div>
                  More about the company
                </div>
                <div className="professional__about-section-content-left-card-info">
                  Location: Rotterdam
                </div>
                <div className="professional__about-section-content-left-card-info">
            ...
            <div className="professional__about-section-content-right">
              <div className="professional__about-section-content-right-header">
                <div className="professional__about-section-content-right-header-heading">
                  Advisor Mechanical Engineers
                </div>
                <img
                  src={professional_about_section_content_right_header_img}
                  alt="professional__about-section-content-right-header-img"
                  className="professional__about-section-content-right-header-img"
                />
              </div>
              <div className="professional__about-section-content-right-link">
                <svg
                  id="envelope"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24.416"
        ...
        <div className="professional__form-section">
          ...
          <div className="professional__form-section-content">
            <div className="professional__form-section-content-left">
              ...
              <div className="professional__form-section-content-left-heading">
                Junior System Engineer Mechanical Engineering
              </div>
              <ul className="professional__form-section-content-left-list">
            ...
            <form className="professional__form-section-content-form">
              <div className="professional__form-section-content-form-row">
                <button
                  className="professional__form-section-content-form-upload-btn"
                  type="button"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="professional__form-section-content-form-row-heading">
                  Upload Your CV
                </div>
              </div>
              <input
                ...
                className="professional__form-section-content-input"
              />
              <input
                type="text"
                placeholder="Surname"
              ...
              <textarea
                ...
                rows="4"
                placeholder="Message"
                className="professional__form-section-content-textarea"
              ></textarea>
              <Button
                variant="dark"
                className="professional__form-section-content-btn"
                type="submit"
              >
                Submit
              </Button>
              <div className="professional__form-section-content-slogan">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="12.21"
                  height="16.28"
